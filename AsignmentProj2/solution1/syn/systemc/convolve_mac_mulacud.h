...
// ==============================================================
#ifndef __convolve_mac_mulacud__HH__
#define __convolve_mac_mulacud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(convolve_mac_mulacud) {
    ...
    SC_CTOR(convolve_mac_mulacud):  simcore_mac_1_U ("simcore_mac_1_U") {
