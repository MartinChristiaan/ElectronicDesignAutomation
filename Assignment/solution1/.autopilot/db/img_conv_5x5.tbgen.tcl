...
set C_modelArgList {
	...
	{ outptr int 8 regular {array 64 { 0 3 } 0 1 }  }
	{ mask int 8 regular {array 25 { 1 1 } 1 1 }  }
	{ shift int 32 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "inptr", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "inptr","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 2047,"step" : 1}]}]}]} , 
 	{ "Name" : "outptr", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "outptr","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 63,"step" : 1}]}]}]} , 
 	{ "Name" : "mask", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "mask","cData": "char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 24,"step" : 1}]}]}]} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "1948", "EstimateLatencyMax" : "1948",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.img_conv_5x5_mac_bkb_U1", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.img_conv_5x5_mac_cud_U2", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.img_conv_5x5_mac_bkb_U3", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	img_conv_5x5 {
		inptr {Type I LastRead 5 FirstWrite -1}
		outptr {Type O LastRead -1 FirstWrite 3}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1948", "Max" : "1948"}
	, {"Name" : "Interval", "Min" : "1949", "Max" : "1949"}
]}
